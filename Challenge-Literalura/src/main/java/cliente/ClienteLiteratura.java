...
import entidad.AutorEntity;
import entidad.LibroEntity;
import conversor.ConvierteDatos;
import modelos.Respuesta;
import repository.AutorRepository;
import repository.LibroRepository;
import api.ConsumoAPI;
...
public class ClienteLiteratura {
    ...
    private void buscarLibros() {
        ...
        if (!libros.isEmpty()) {
            ...
            System.out.println("\n\n ----- No se encontraron resultados de ese libro ---- \n\n");
        }
    ...
    private void buscarAutoresVivo() {
        System.out.println("Escriba el año para en el que vivió dicho autor: ");
    ...
    private void buscarPorIdiomas() {
        ...
        if (!libros.isEmpty()) {
            ...
            System.out.println("\n\n ----- No se encontraron resultados de ese idioma ---- \n\n");
        }
